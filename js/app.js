...
const ELEVENLABS_API_KEY = '__ELEVENLABS_API_KEY__';
const ELEVENLABS_VOICE_ID = '21m00Tcm4TlvDq8ikWAM'; // Rachel (change as needed)
...
function sendMessage() {
  ...
  setTimeout(() => {
    if (isAgentsEnabled()) {
      renderAgentsResponse(text, activeSkill ? activeSkill.preprompt : '');
    } else {
...
async function speakText(text) {
  if (!ELEVENLABS_API_KEY || ELEVENLABS_API_KEY === '__ELEVENLABS_API_KEY__') {
